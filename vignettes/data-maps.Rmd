...
=======
>>>>>>> ad718027c745300d7f897a47d2d2460a497c8808
...
```
<<<<<<< HEAD
```{r map_b3_pipe-map, echo = FALSE}
=======
```{r map3_pipe-print, echo = FALSE}
>>>>>>> ad718027c745300d7f897a47d2d2460a497c8808
library(magrittr)
...
=======
  print_osm_map(filename = 'map_b3_pipe.png', 
>>>>>>> ad718027c745300d7f897a47d2d2460a497c8808
               width = 600,
               units = 'px', 
               dpi = map_dpi)
...
```{r, echo = FALSE}
#Note from beemyfriend:
#I don't think connect_highways(highways, bbox) and hwys[[i]] are the same...
#Also, I got rid of highways4 in the above code because it was never used
