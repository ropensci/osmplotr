...
[overpass API](https://overpass-api.de).  The following map can be made by
following the subsequent simple steps:
...
## 1. Combining multiple OSM objects
...
### 4.3 The Colour Matrix: Colouring Several Regions
