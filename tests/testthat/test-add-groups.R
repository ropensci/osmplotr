...
test_that ('cols', {
           ...
           expect_message (add_osm_groups (map, obj, groups = list (pts),
                                           cols = 1),
...
test_that ('groups', {
           ...
           expect_error (add_osm_groups (map, obj,
                                         groups = list (london$dat_HP)),
...
test_that ('boundary', {
           ...
           expect_silent (add_osm_groups (map, obj, grps, 1, 2,
                                          boundary = NULL))
})
...
test_that ('make_hull', {
           ...
           grps <- list (pts, pts, pts)
           expect_warning (add_osm_groups (map, obj, grps, 1, bg = 2,
                                           make_hull = 1:2),
