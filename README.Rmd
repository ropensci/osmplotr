...
dat_B <- osmdata_sp (q1, quiet = FALSE)$osm_polygons
q1 <- add_feature (q0, key = "highway")
dat_H <- osmdata_sp (q1, quiet = FALSE)$osm_lines
q1 <- add_feature (q0, key = "leisure", value = "park")
dat_P <- osmdata_sp (q1, quiet = FALSE)$osm_polygons
q1 <- add_feature (q0, key = "landuse", value = "grass")
dat_G <- osmdata_sp (q1, quiet = FALSE)$osm_polygons
