...
convex hull of the `xy` points as that colour. (In this case, there are no such
points, but where they do exist, they may be included in the interpolation with
`bg=NULL`.)
```{r, eval=FALSE}
